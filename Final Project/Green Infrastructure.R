...
#Tabulated the status and asset type columns to get some information on what variables were included in the data set.  

types<-tabyl(green_final, asset_type)
status<-tabyl(green_final, status)
